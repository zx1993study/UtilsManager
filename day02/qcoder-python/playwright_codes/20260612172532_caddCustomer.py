...
def run(playwright: Playwright) -> List[str]:
    ...
    page.get_by_role("dialog", name="添加终端客户").get_by_placeholder("请输入客户名称").dblclick()
    ...
    page.get_by_role("dialog", name="添加终端客户").get_by_placeholder("请选择终端类型").dblclick()
    page.get_by_role("dialog", name="添加终端客户").get_by_placeholder("请选择终端类型").click()
    page.get_by_role("dialog", name="添加终端客户").get_by_placeholder("请选择终端类型").click()
    page.locator("div").filter(has_text=re.compile(r"^终端类型$")).first.dblclick()
    page.locator("div").filter(has_text=re.compile(r"^终端类型$")).first.click()
    ...
    page.get_by_role("dialog", name="添加终端客户").get_by_placeholder("请选择产品类型").dblclick()
    ...
    page.get_by_role("listitem").filter(has_text="C类").dblclick()
    page.get_by_role("listitem").filter(has_text="B类").click()
    page.get_by_role("listitem").filter(has_text="C类").click()
    page.get_by_role("listitem").filter(has_text="D类").dblclick()
    ...
    page.get_by_role("listitem").filter(has_text="D类").click()
    page.get_by_role("listitem").filter(has_text="零售样板店").dblclick()
    ...
    page.get_by_role("dialog", name="添加终端客户").get_by_placeholder("请选择合作状态").dblclick()
    ...
    page.get_by_role("listitem").filter(has_text=re.compile(r"^洪山$")).click()
    page.get_by_role("listitem").filter(has_text=re.compile(r"^洪山$")).dblclick()
    page.get_by_role("listitem").filter(has_text=re.compile(r"^洪山a1$")).click()
    page.get_by_role("listitem").filter(has_text="洪山a2").dblclick()
    page.get_by_role("listitem").filter(has_text="洪山a2").dblclick()
